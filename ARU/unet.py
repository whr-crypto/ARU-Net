...
from nets.unet import n_unet as unet
...
class Unet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"    : 'model_weights_data/unet_TUSI.pth',
        #--------------------------------#
        #   所需要区分的类的个数+1
        #--------------------------------#
        "num_classes"   : 2,
    ...
    def __init__(self, **kwargs):
        ...
        '''if self.num_classes <= 21:
            self.colors = [ (0, 0, 0), (225, 225, 225), (0, 128, 0), (128, 128, 0), (0, 0, 128), (128, 0, 128), (0, 128, 128),
